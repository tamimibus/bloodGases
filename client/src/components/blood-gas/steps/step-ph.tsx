...
const getpHInterpretation = (ph: number | undefined) => {
  ...
  if (ph < 7.35) {
    return {
      status: "Acidaemia",
      description: "pH is below normal range, indicating acidaemia. This will lead to either respiratory or metabolic acidosis pathways.",
  ...
  if (ph > 7.45) {
    return {
      status: "Alkalaemia",
      description: "pH is above normal range, indicating alkalaemia. This will lead to either respiratory or metabolic alkalosis pathways.",
  ...
  return {
    status: "Normal",
    description: "pH is within normal range. However, a normal pH doesn't exclude an acid-base disorder - compensation may be present.",
        ...
        <div className="grid gap-4 md:grid-cols-3 text-sm">
          <div className="space-y-1">
            ...
            <p className="text-muted-foreground">
              Indicates excess acid or loss of base in the blood. May be respiratory or metabolic in origin.
            </p>
          </div>
          <div className="space-y-1">
            <p className="font-medium text-clinical-green">Normal (pH 7.35-7.45)</p>
            <p className="text-muted-foreground">
              Normal acid-base balance. However, compensation may mask underlying disorders.
            </p>
          </div>
          <div className="space-y-1">
            <p className="font-medium text-clinical-orange">Alkalaemia (pH {">"} 7.45)</p>
            <p className="text-muted-foreground">
              Indicates excess base or loss of acid in the blood. May be respiratory or metabolic in origin.
            </p>
          </div>
        </div>
      </CardContent>
